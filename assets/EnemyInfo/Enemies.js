...
export var enemies = {
    ...
    calamar: {class: Veneno, name:"H", maxHp:80, atk: 20, def: 10, prefType: "", imgLink: ""}, crit: 10,
    ...
    magdalena: {class: Cura, name:"María Magdalena", maxHp:70, atk: 20, def: 15, prefType: "", imgLink: "", crit: 10},
