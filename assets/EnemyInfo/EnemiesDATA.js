export var enemies = {
    botella: {class: "Enemigo", name:"Flipper", maxHp:60, atk: 30, def: 15, prefType: "", imgLink: "furro.jpg", crit: 10},

    calamar: {class: "Veneno", name:"H", maxHp:70, atk: 20, def: 10, prefType: "", imgLink: ""}, crit: 10,

    cocacola: {class: "Enemigo", name:"Julián", maxHp:60, atk: 35, def: 10, prefType: "", imgLink: "furro.jpg", crit: 10},
    ...
    pollo: {class: "AoE", name:"Poyo", maxHp:40, atk: 30, def: 5, prefType: "", imgLink: "furro.jpg", crit: 15},
