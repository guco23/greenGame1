...
export class EscenaTilesets extends Phaser.Scene {
    ...
    create() {
        ...
        let slimes = [
            new SlimeEnemigo(this, 0, 0, 0, 50, 140, "pene de plastico", [enemies.botella, enemies.acuarius, enemies.botella], this.WallLayer, this.character, this.myGameData, 'enem1')
        ];
