...
init(data){
    ...
    create() {        
        ...
        let slimes = [
            ...
            new SlimeEnemigo(this, 100, 1, 0, 2283, 792, items.chalecoBronce, [enemies.pirania, enemies.pezGlobo], this.WallLayer, this.character, this.myGameData, 'enem11'),
            ...
            new SlimeEnemigo(this, 100, 1, 0, 2295, 1919, items.chalecoBronce, [enemies.cangrejo, enemies.platanoMaduro, enemies.platanoMaduro, enemies.platanoMaduro], this.WallLayer, this.character, this.myGameData, 'enem13'),
            ...
            new SlimeEnemigo(this, 100, 1, 1, 2000, 2192, undefined, [enemies.medusa, enemies.langosta, enemies.medusa], this.WallLayer, this.character, this.myGameData, 'enem15'),
            ...
            new SlimeEnemigo(this, 100, 1, 1, 903, 1966, undefined, [enemies.cangrejo, enemies.botella2, enemies.langosta], this.WallLayer, this.character, this.myGameData, 'enem17'),
            new SlimeEnemigo(this, 100, 0, 1, 966, 1709, undefined, [enemies.pezPayaso, enemies.pepsi, enemies.pepsi, enemies.medusa], this.WallLayer, this.character, this.myGameData, 'enem18'),
            new SlimeEnemigo(this, 100, 1, 0, 1060, 1301, items.escudoHierro, [enemies.pezPayaso, enemies.pezPayaso, enemies.pezPayaso, enemies.pezPayaso], this.WallLayer, this.character, this.myGameData, 'enem19'),

            new SlimeEnemigo(this, 100, 1, -1, 2896, 2178, items.guanteCueroPlus, [enemies.langosta, enemies.pezPayaso, enemies.langosta], this.WallLayer, this.character, this.myGameData, 'enem20'),
            ...
            new SlimeEnemigo(this, 100, 0, 1, 3430, 2036, undefined, [enemies.calamar, enemies.cangrejo, enemies.calamar], this.WallLayer, this.character, this.myGameData, 'enem22'),

            new SlimeEnemigo(this, 100, 0, 1, 3430, 1925, undefined, [enemies.pezGlobo, enemies.medusa, enemies.pepsi, enemies.pepsi], this.WallLayer, this.character, this.myGameData, 'enem23'),
